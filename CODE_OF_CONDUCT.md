...
(issues, pull requests, discussions), and any official project communication
channels — and when an individual is officially representing the project in
public spaces.
...
*(As a young project with a single maintainer there is currently no
alternative reporting contact; one will be designated as the maintainer
team grows.)*
