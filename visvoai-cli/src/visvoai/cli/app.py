...
from visvoai.cli.session_state import SessionStateMixin
...
class VisvoApp(DemoMixin, AgentTurnMixin, SessionsMixin, CommandsMixin, RewindMixin, RenderMixin, SessionStateMixin, App):
    TITLE = "visvoai"
